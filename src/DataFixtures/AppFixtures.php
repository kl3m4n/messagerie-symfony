...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        for($i = 1; $i <= 3; $i++) {
            $usr2 = new User();
            $usr2 -> setUsername('user' . $i);
            $usr2 -> setEmail('user' . $i . '@gmail.com');
            $usr2 -> setPassword('$argon2id$v=19$m=65536,t=4,p=1$XVd2PdquPh8cs/7o6TPi9g$yQAIP97zrOrmPDzYPAYoVodd8u9jYTLCBqG/eEo2O+0');
            $usr2 -> setImg('default.png');
